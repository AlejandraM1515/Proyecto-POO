...
int main() {
    ...
    if (tipo_cli == 1){
        cliente = new Cliente_regular(id_cliente, nombre_cliente, correo_cliente, telefono_cliente, 0);
    } else {
        cliente = new Cliente_vip(id_cliente, nombre_cliente, correo_cliente, telefono_cliente, "Palomitas gratis + Refresco");
    }
